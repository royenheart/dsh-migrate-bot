...
| [installation.md](installation.md) | Installing the Action, every configuration key and its default, the feedback channels, and the checklist an agent follows when configuring it | Design rationale, which belongs in `design/` |
